...
export default function VideoStatistic({ count = 0, digits = 1, label, dislikes, likes, views }) {
  return (
    <div className='flex items-center p-2 px-2.5 text-sm lg:p-3 lg:px-3.5 select-none gap-2 bg-slate-100 rounded-full'>
